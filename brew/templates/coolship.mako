...
<div class="content">
  <div class="impact header" style="text-align:center; padding-top:20px; padding-bottom:10px; border-top:1px solid black;">
    <h1>The Coolship Startup Incubator.</h1><h4>TBD's Project to Accelerate Business Ventures in Fermentation Technology.</h4>
  </div>
  ...
  <div class="row-fluid">
    <div class = "span7 offset2">
      <p>
        ...
        TBD Coolship will be a gathering space for people passionate about beer. By offering classes, brewery tours, talks, collaborative projects, and educational outreach we can turn beer lovers into beer brewers. These brewers have limitless new ideas on how to make the brewing process and product, better. Involving the community in manufacturing and education brings brewing back to its roots.  Our brewery will be open lab, inspiring new citizen-scientists by engaging the community in all aspects of the brewing process.  The Coolship will undertake extensive outreach to local universities and organizations to promote education and scientific inquiry.
      </p><p>
        Founded by scientists, the TBD brewery sees its role in not just manufacturing beer, but in developing recipes, yeasts, and equipment that push the envelope of the brewing field. By promoting collaboration across disciplines and sampling from the fertile minds of Cambridge residents, the second role of the Coolship is to foster researchers and entrepreneurs to develop technology. Cooperative projects, conceived and headed by ‘Coolship Fellows’, will produce new, commercially viable products for the brewery itself or brewing related startups. We have a bold focus on combining cutting-edge biological techniques with centuries old brewing methods. Our flexible space and local talent allow for the creation of innovative, patentable materials and prototypes.  By leveraging the resources of a scientific-minded brew lab with a community of engaged, amateur-experts we can achieve the spontaneous, novel products our namesake represents.
      </p><p>
